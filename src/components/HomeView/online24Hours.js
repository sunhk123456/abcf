...
import styles from "./online24Hours.less"



    /** 组件 * */
class Online24Hours extends PureComponent {
    ...
    constructor(props) {
      ...
      createChart = (data) => {
        ...
        const { titleSize, titleWeight, titleFamily, xAxisSize, tooltipSize } = fontsize;
        ...
        const option = {
          ...
          tooltip: {
            ...
            formatter(params) {
              ...
              return `${params[0].axisValue}时 <br /> ${showTip}`;
            },
          },
          xAxis: {
            type: 'category',
