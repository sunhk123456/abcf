...
class TimeEchart3 extends Component {
  ...
  download = (e) => {
    ...
    e.stopPropagation();
    DownloadFile(this.jsonHandle(),flag==="01" ? "timeEchart3":null);
  };
  ...
  render() {
    ...
    return (
      <div id="timeEchart3" className={styles.page}>
