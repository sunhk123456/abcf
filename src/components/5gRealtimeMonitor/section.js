...
class Section5G extends PureComponent{
  ...
  */
  ...
  handleData(data) {
    ...
    if(!isEqual(result.peopleData,peopleData) || !isEqual(result.areaData,areaData) || !isEqual(result.productData,productData)){
